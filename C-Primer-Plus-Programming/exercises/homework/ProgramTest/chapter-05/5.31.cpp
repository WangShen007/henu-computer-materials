...
int main()
{
    ...
    for(int i = 0;i < 12;i++)
    {
        if(i == 0 || i == 2 || i == 4 || i == 6 || i == 7 || i == 9 || i == 11)//0 2 4 6 7 9 11
        {
            daycount = 31;
        }
        else if( i == 1)
        ...
        cout<<"-----------------------------------------------"<<endl;
        cout<<" "<<"Sun"<<setw(7)<<"Mon"<<setw(7)<<"Tue"<<setw(7)<<"Wed"<<setw(7)<<"Thu"<<setw(7)<<"Fri"<<setw(7)<<"Sat"<<" "<<endl;

        cout<<" ";
        for(int y = 0; y < day[i];y++)
        {
            cout<<"       ";
        }
