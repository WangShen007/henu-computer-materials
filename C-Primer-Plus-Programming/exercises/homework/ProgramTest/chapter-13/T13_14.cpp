...
void test01()
{
    ...
    ofstream ofs;
    ofs.open("Exercise13_14.dat", ios::out | ios::binary);
    if (!ofs)
    {
...
{
    ifstream ifs;
    ifs.open("Exercise13_14.dat", ios::in | ios::binary);
    if (!ifs)
    {
...
/*void test01()
{
    Loan loan1(5.0, 5, 10000);
    Loan loan2();
    Loan loan3(10.0, 15, 30000);
    Loan loan4();
    Loan loan5(15.0, 25, 50000);
    ofstream ofs;
    ofs.open("Exercise13_14.dat", ios::out | ios::binary);
    if (!ofs)
    {
    ...
    ofs.write((const char *)&loan1, sizeof(loan1));
    ofs.write((const char *)&loan2, sizeof(loan2));
    ofs.write((const char *)&loan3, sizeof(loan3));
    ofs.write((const char *)&loan4, sizeof(loan4));
    ofs.write((const char *)&loan5, sizeof(loan5));
    ofs.close();
}*/
/*
