...
//    cin>>income;
    ...
    else if (status == 3)
    {
        if (income <= 11950)
            ...
            tax = 11950 * 0.10 + (45500 - 11950) * 0.15 +
            (117450 - 45500) * 0.25 + (171550 - 190200) * 0.28 +
            (income - 190200) * 0.33;
        else
            tax = 11950 * 0.10 + (45500 - 11950) * 0.15 +
            (117450 - 45500) * 0.25 + (171550 - 190200) * 0.28 +
...
//    cout<<"Tax is "<<static_cast<int>(tax * 100) / 100.0<<endl;
    return static_cast<int>(tax * 100) / 100.0;

}
int main()
{
    cout<<"应纳税收入    单身纳税者    夫妻联合纳税者    夫妻分别纳税者    户主纳税者"<<endl;
    for(int i = 50000;i <= 60000;i += 50)
    {
        cout<<fixed<<setprecision(0)<<"  "<<left<<setw(13)<<i<<setw(17)<<computeTax(0, i)<<setw(16)<<computeTax(1, i)<<setw(18)<<computeTax(2, i)<<setw(16)<<computeTax(3, i)<<endl;
    }
}
