...
{
    internal class MyToolCurve : MyToolObject
    {
        private readonly int minDistance = 15;
        ...
        public override void OnMouseDown(MyUC myuc, MouseEventArgs e)
        {
            ...
            Point p = new(e.X, e.Y);
            MyDrawCurve w = new(p, Color.Red, 2, MyCC.ID);
            AddNewObject(myuc, w);
            myLastPoint = p;
        ...
        public override void OnMouseMove(MyUC myuc, MouseEventArgs e)
        {
            ...
            MyDrawCurve w = (MyDrawCurve)myuc.Graphics[index]!;
