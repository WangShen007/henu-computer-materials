...
namespace ClientWinFormsExamples.ch07.E06
{
    internal class ToolCurve : ToolObject
    {
        ...
        public ToolCurve(E0706DrawForm fm):base(fm)
        {
            this.fm = fm;
        }
        ...
        public override void OnMouseDown(PanelUC palette, MouseEventArgs e)
        {
            ...
            Point p = new(e.X, e.Y);
            DrawCurve w = new(fm, p, Color.Red, 2, fm.UC1.ID);
        ...
        public override void OnMouseUp(PanelUC palette, MouseEventArgs e)
        {
            ...
            int index = fm.UC1.FindObjectIndex();
            DrawCurve w = (DrawCurve)palette.Graphics[index]!;
            ...
            if (count > 2)
            {
                ...
                fm.MyClient?.SendToServer(string.Format("DrawMyCurve,{0},{1},{2},{3},{4}",
