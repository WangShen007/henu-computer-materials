...
namespace ClientWinFormsExamples.ch07.E06
{
    ...
    class DrawArrowCurve : DrawCurveHandle
    {
        ...
        public DrawArrowCurve(E0706DrawForm fm) : base(fm)
        {
            this.fm = fm;
        }
        ...
        public DrawArrowCurve(E0706DrawForm fm, Point p, Color mycolor, int myPenWidth, int id) : base(fm)
        {
            this.fm = fm;
            AddPoint(p);
            PenColor = mycolor;
        ...
        public DrawArrowCurve(E0706DrawForm fm, List<Point> myPointList, int myPenWidth, Color mycolor, int id) : base(fm)
        {
            this.fm = fm;
